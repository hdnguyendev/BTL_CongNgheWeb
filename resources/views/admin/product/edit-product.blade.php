                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @foreach ($edit_product as $key => $item)
                            <form role="form" method="post" action="{{ URL::to('/update-product/' . $item->product_id) }}"
                                ...
                                <div class="card-style mb-30">
                                    ...
                                    <div class="input-style-1">
                                        ...
                                        <div class="input-style-1">
                                            ...
                                            <input type="number" name="product_soluong"
                                                value="{{ $item->product_soluong }}" />
                                        </div>
                                        <img src="{{ asset('upload/productImage/' . $item->product_image) }}" alt=""
