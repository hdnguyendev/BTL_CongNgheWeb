        ...
        <div class="container">
            <div class="row justify-content-center">
                            ...
                            <li data-vjstepno="1">
                                <form>
                                    ...
                                    <section class="checkout-steps-form-content">
                                        <div class="row">
                                            <h4 class="form-control mt-10">THÔNG TIN ĐẶT HÀNG</h4>
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-input form">
                                                            <input type="text" name="shipping_name" class="shipping_name"
                                                                value="{{ Session::get('customer_name') ? Session::get('customer_name') : '' }}"
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="shipping_email" class="shipping_email"
                                                            value="{{ Session::get('customer_email') ? Session::get('customer_email') : '' }}"
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="shipping_phone" class="shipping_phone"
                                                            value="{{ Session::get('customer_phone') ? Session::get('customer_phone') : '' }}"
                                                ...
                                                <div class="single-form form-default mb-20">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="shipping_address"
                                                            ...
                                                            value="{{ Session::get('customer_address') ? Session::get('customer_address') : '' }}">
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- Con tin yeu --}}
                                                ...
                                                {{-- <div class="form-group mb-20">
                                                    ...
                                                    <select name="city" id="city"
                                                        ...
                                                        @foreach ($city as $key => $ci)
                                                            <option value="{{ $ci->matp }}">{{ $ci->name_city }}
                                                            </option>
                                                        @endforeach
                                                    ...
                                                    <div class="select-elements select-style-2 mt-30">
                                                        ...
                                                        <div class="select-items select">
                                                            <select name="payment_select"
                                                                class="form-control input-md m-bot15 payment_select"
                                                                style="width: 100%">
                                       ...
                                       <option value="3">Thanh toán qua tài khoản ngân hàng</option> --}}
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-form form-default">
                                                        ...
                                                        <div class="form-input form">
                                                            <input name="shipping_notes" cols="90" rows="50"
                                                ...
                                                @if (isset($_SESSION['coupon']))
                                                    <input type="hidden" name="order_coupon" class="order_coupon"
                                                        value="{{ $_SESSION['coupon']['coupon_code'] }}">
                                                @else
                                                    <input type="hidden" name="order_coupon" class="order_coupon"
                                                        value="no">
                                                @endif
                                            ...
                                            {{-- <input type="button" value="ĐẶT HÀNG" name="calculate_order"
                                                class="btn btn-primary calculate_delivery"
                                                href="{{ URL::to('final-checkout') }}"> --}}
                ...
                <div class="col-lg-4">
                    ...
                    <div class="checkout-sidebar-accordion ">
                                                            ...
                                                            <td class="checkout-product">
                                                                <div class="product-cart d-flex">
                                                                    <div class="product-thumb">
                                                                        <img src="{{ asset('upload/productImage/' . $cart['product_image']) }}"
                                                                            alt="">
                                                                    </div>
                                                                    <div class="product-content media-body">
                                                                        <h5 class="title"><a
                                                                                href="product-details-page.html">{{ $cart['product_name'] }}</a>
                                                                        </h5>
                                                                        <ul>
                                                                            <li><span>SL: {{ $cart['product_qty'] }}</span>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="pricing-table">
                                            <div class="sub-total-price">
                                                ...
                                                <div class="total-price shipping">
                                                    ...
                                                    @else
                                                        <p class="price">
                                                            {{ number_format(Session::get('fee'), 0, ',', '.') }}</p>
                                                    @endif
                                                </div>
                                                @if (isset($_SESSION['coupon']))
                                                    <div class="total-price discount">
                                                        <p class="value">Mã giảm:</p>
                                                        <p class="price"> {{ $_SESSION['coupon']['coupon_number'] }} %
                                                        </p>
                                                        <p>
                                                            @php
                                            ...
                                            <div class="price-table-btn">
                                                <a name="send_order" class="main-btn primary-btn-border  send_order">Xác
                                                    nhận đơn hàng</a>
                                            </div>
                                        </div>
                                    </div>
